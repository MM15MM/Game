...
public class FirebaseManager : MonoBehaviour
{
    ...
    public void SaveDataButton()
    {
        ...
        StartCoroutine(UpdateHighscore(int.Parse(scoreField.text)));
    ...
    private IEnumerator Login(string _email, string _password)
    {
        ...
        if (LoginTask.Exception != null)
        {
            ...
            string message = "Accesso Faillito!";
            switch (errorCode)
            {
    ...
    private IEnumerator Register(string _email, string _password, string _username)
    {
        ...
        else if (passwordRegisterField.text != passwordRegisterVerifyField.text)
        {
            ...
            warningRegisterText.text = "Le Password non corrispondono!";
        }
        else
        {
            //Call the Firebase auth signin function passing the email and password
            ...
            else
            {
                ...
                if (User != null)
                {
                    ...
                    if (ProfileTask.Exception != null)
                    {
                        ...
                        warningRegisterText.text = "Inserimento Username Fallito!";
                    }
                    else
                    {
                        //Username is now set
    ...
    private IEnumerator UpdateHighscore(int _score)
    {
        //Set the currently logged in user xp
        var DBTask = DBreference.Child("users").Child(User.UserId).Child("highscore").SetValueAsync(_score);
    ...
    private IEnumerator LoadScoreboardData()
    {
        ...
        else
        {
            ...
            foreach (DataSnapshot childSnapshot in snapshot.Children.Reverse<DataSnapshot>())
            {
                ...
                scoreboardElement.GetComponent<ScoreElements>().NewScoreElement(username, highscore);
            }
